...
progInterface.add_resource(ConferenceAttendeesList, '/conferences/<int:cid>/attendees')
progInterface.add_resource(ConferenceAttendees, '/conferences/<int:cid>/attendees/<string:email>')
