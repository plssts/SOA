...
@XmlRootElement(name = "putAttendeeResponse", namespace = "http://ws.soap.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "putAttendeeResponse", namespace = "http://ws.soap.com/")
public class PutAttendeeResponse {
